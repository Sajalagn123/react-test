...
import coverImage from '../../assets/personal/newPhoto.jpg';
  ...
  return (
    <section className="my-5">
      <div className="my-2">
        ...
        <p>
        In a world becoming more increasingly reliant on technology, I plan to use my development knowledge to create and design websites that are user friendly, well designed, and useful to others. My hope is that what I create will aid people in having an easy and realxing experience, whether it is because they are entertained by my website or find it useful.
        </p>
      </div>
    </section>
  );
